...
<div style="width: 600px; padding: 150px; margin:auto; text-align:center; font-family: KakaoBold; font-size: 30px; color: #555;">
	<div style="margin-top: 20px; margin-bottom: 10px">
		...
		<span style="font-family: KakaoLight; font-size: 15px;">(회원가입시 주소Api, 카카오 소셜로그인 구현)</span><br>
		<span style="font-family: KakaoLight; font-size: 15px;">게시판 관리 기능 - 카테고리 별 조회, 페이징, 파일 첨부, 게시글 등록, 수정</span><br>
		<span style="font-family: KakaoLight; font-size: 15px;">- 카카오톡 공유 기능 구현</span><br>
		...
		<span style="font-family: KakaoLight; font-size: 12px;">개발기간: 2022.11.03. ~ 2022.11.17. (2주)</span><br>
	</div>
</div>
